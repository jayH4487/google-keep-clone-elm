...
var $author$project$Main$noteCoordsE = _Platform_incomingPort(
	'noteCoordsE',
	A2(
		...
		switch (msg.$) {
			...
			case 'OpenToolTip':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{colorToolTipId: value, showColorToolTip: true}),
					$author$project$Main$colorToolBar(
			...
			case 'ChangeColor':
				...
				var amendedNotes = A2(
					$elm$core$List$map,
					function (note) {
						return _Utils_eq(note.id, model.colorToolTipId) ? _Utils_update(
							note,
							{color: value}) : note;
					},
					model.notes);
			...
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{colorToolTipId: 0, showColorToolTip: false}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Main$ChangeColor = function (a) {
	return {$: 'ChangeColor', a: a};
};
var $author$project$Main$CloseToolTip = {$: 'CloseToolTip'};
...
var $author$project$Main$colorDecoder = A2(
	$elm$json$Json$Decode$at,
	_List_fromArray(
		['target', 'dataset', 'color']),
	$elm$json$Json$Decode$string);
var $author$project$Main$onClickColor = function (message) {
	return A2(
		$elm$html$Html$Events$on,
		'click',
		A2($elm$json$Json$Decode$map, message, $author$project$Main$colorDecoder));
};
...
var $author$project$Main$viewColorTooltip = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('color-tooltip'),
				A2($elm$html$Html$Attributes$style, 'display', 'flex'),
				A2(
				$elm$html$Html$Attributes$style,
				'transform',
				'translate(' + ($elm$core$String$fromInt(model.noteCoords.x) + ('px, ' + ($elm$core$String$fromInt(model.noteCoords.y) + 'px)')))),
				$elm$html$Html$Events$onMouseLeave($author$project$Main$CloseToolTip),
				$author$project$Main$onClickColor($author$project$Main$ChangeColor)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$attribute, 'data-color', '#fff'),
						$elm$html$Html$Attributes$id('white')
					]),
				_List_Nil),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('color-option'),
						A2($elm$html$Html$Attributes$attribute, 'data-color', '#d7aefb'),
						$elm$html$Html$Attributes$id('purple')
					]),
				_List_Nil),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('color-option'),
						A2($elm$html$Html$Attributes$attribute, 'data-color', '#fbbc04'),
						$elm$html$Html$Attributes$id('orange')
					]),
				_List_Nil),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('color-option'),
						A2($elm$html$Html$Attributes$attribute, 'data-color', '#a7ffeb'),
						$elm$html$Html$Attributes$id('teal')
					]),
				_List_Nil)
			]));
};
...
var $author$project$Main$viewFormContainer = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('note-title'),
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('form-buttons'),
								A2(
								$elm$html$Html$Attributes$style,
								'display',
								model.isFormOpen ? 'block' : 'none')
		...
		[
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$src('https://www.gstatic.com/images/branding/product/1x/keep_48dp.png')
				]),
			_List_Nil),
			A2(
			$elm$html$Html$h2,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('note-text')
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('toolbar-container')
					]),
				_List_fromArray(
					[
						A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										$author$project$Main$OpenToolTip(note.id))
									]),
								_List_Nil),
								A2(
								$elm$html$Html$img,
...
var $author$project$Main$viewNotes = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		A2($elm$core$List$map, $author$project$Main$viewNote, model.notes));
};
var $elm$html$Html$p = _VirtualDom_node('p');
var $author$project$Main$viewPlaceholder = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$id('placeholder')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$id('placeholder-text')
				]),
			_List_fromArray(
				[
					$elm$html$Html$text('Notes you add appear here')
				]))
		]));
